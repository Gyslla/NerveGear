function cfs2cam_analisegy( DATA )
...
% por isso temos que controlar o que � plotado na tela
...
%
% DATANUM (data no sistema do MATLAB). N�o mexer.
%
...
%
% TRATAMENTO DO ARQUIVO DE AN�LISE DO CFS
%
%
% Abre arquivo de CI (condi��o inicial)
%
ARQUIVO_COM_CAMINHO=sprintf('./DADOS_CI_CC/%s/CI/%s',DATA,NOME_DO_ARQUIVO_ANALISE_CFS);
ng=ncgeodataset(ARQUIVO_COM_CAMINHO);

%
%  interpola a grade do CFS na grade do CAM (plota ambas as interpola�oes
%  de AJUSTE = true
%
...
%
% o ideal seria o nivel mais baixo da variavel T mas a diferenca � muito
