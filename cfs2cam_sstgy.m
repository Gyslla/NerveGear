...
%
% defini�a� do arquivo de TSM do CAM (orignal e o de saida)
% 
...
% adquire dados
%
%opcao=input('Baixar os dados de an�lise do CFS (S/N)?','s');
...
%end
%
%plota os graficos (true) ou n�o (false)
%
...
% A INTERPOLA��O. ENTAO USO TEMPERATURA SIGMA 1 PARA
...
for i=1:12
    ...
    % isto � record#1 jan  record#2 fevereiro etc...
    %
    TMP2=D(X1,Y1);
